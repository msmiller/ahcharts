...
$rawdata = importcsv($datadir."lethality.csv");
...
'position'=>"outside", 'size'=>11, 'color'=>"666666",
'alpha'=>75, 'decimals' => 0, 'bold' => false );

$chart [ 'chart_data' ][0] = array (' ', $rawdata[0][1], $rawdata[0][2]); // TW raw data removed
